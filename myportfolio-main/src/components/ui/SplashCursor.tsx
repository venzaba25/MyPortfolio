...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function compileShader(type: any, source: string, keywords: any) {
  ...
  }, [CURL, DENSITY_DISSIPATION, DYE_RESOLUTION, PRESSURE, PRESSURE_ITERATIONS, SIM_RESOLUTION, SPLAT_FORCE, SPLAT_RADIUS, VELOCITY_DISSIPATION, COLOR_UPDATE_SPEED, SHADING]);
